...
DrawUTF8(p.window, word_left, textXpos_left, p.textYpos, p.textColor);
DrawUTF8(p.window, word_right,textXpos_right, p.textYpos, p.textColor);
...
if strcmp(response, 'LeftArrow')
    DrawUTF8(p.window,'*', p.xCenter - 500, p.yCenter+400, p.textColor);
